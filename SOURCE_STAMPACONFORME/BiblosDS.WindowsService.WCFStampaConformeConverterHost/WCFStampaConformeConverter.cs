...
{
    partial class WCFStampaConformeConverter : ServiceBase
    {
        public ServiceHost serviceHostStampaConforme = null;
        log4net.ILog logger = log4net.LogManager.GetLogger(typeof(WCFStampaConformeConverter)); 
        
        public WCFStampaConformeConverter()
        {
             InitializeComponent();
