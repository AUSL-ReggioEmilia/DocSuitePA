...
namespace BiblosDS.Library.Common.Objects
{
    ...
    /// </summary>    
    [DataContract(Name = "StorageAreaRule", Namespace = "http://BiblosDS/2009/10/DocumentStorageAreaRule")]
    public partial class DocumentStorageAreaRule : BiblosDSObject
    {
        [DataMember]
        ...
        public DocumentStorageAreaRule()
        {
        }
