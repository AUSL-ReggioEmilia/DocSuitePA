...
{
    [ServiceContract(Namespace = "http://Vecomp.BiblosDs.IPreservationAdministration")]
    public interface IPreservationAdministration
    {
        ...
        /// <summary>
        /// Ottiene la lista delle conservazioni associate ad un archivio.
        /// </summary>
        /// <param name="archiveName"></param>
        /// <returns></returns>
        [OperationContract]
        BindingList<Preservation> GetPreservationsFromArchive(string archiveName);
        ...
        /// <returns></returns>
        [OperationContract]
        BindingList<PreservationTaskGroup> GetPreservationTaskGroupsByScheduleAndGroupType(Guid idSchedule, Guid idTaskGroupType, string archiveName);
        ...
        /// <returns></returns>
        [OperationContract]
        BindingList<PreservationStorageDevice> GetPreservationStorageDevices(Nullable<Guid> idPreservationStorageDevice, string archiveName);
        ...
        /// <returns></returns>
        [OperationContract]
        BindingList<PreservationInStorageDevice> GetPreservationsInStorageDevices(Nullable<Guid> idPreservation, Nullable<Guid> idPreservationStorageDevice);
        ...
        [OperationContract]
        void PreservationStorageDeviceChangeStatus(Guid idPreservation, PreservationStatus preservationStatus);
        ...
        /// <returns></returns>
        [OperationContract]
        byte[] CreateArchivePreservationMark(Guid idStorageDevice, string archiveName);
    }
}
