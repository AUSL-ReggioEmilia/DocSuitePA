...
namespace VecompSoftware.BPM.Integrations.Modules.AFOL.ERP.Invoice.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.AFOL.ERP.Invoice";
