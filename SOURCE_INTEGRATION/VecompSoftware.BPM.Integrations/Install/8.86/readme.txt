...
Rimuovere tutte le librerie del modulo VecompSoftware.BPM.Integrations.Modules.VSW.FascicleClose prima di copiare la nuova versione.
Mantenere il file json di configurazione

#FL
######################################################################################################
Rimuovere tutte le librerie del modulo VecompSoftware.BPM.Integrations.Modules.VSW.FascicleDocumentUnit prima di copiare la nuova versione.
Mantenere il file json di configurazione

#FL
######################################################################################################
Rimuovere tutte le librerie del modulo VecompSoftware.BPM.Integrations.Modules.VSW.PeriodicFascicle prima di copiare la nuova versione.
Mantenere il file json di configurazione
