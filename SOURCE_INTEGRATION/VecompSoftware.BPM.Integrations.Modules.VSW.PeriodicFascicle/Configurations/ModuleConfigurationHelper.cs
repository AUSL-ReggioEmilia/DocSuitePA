...
namespace VecompSoftware.BPM.Integrations.Modules.VSW.PeriodicFascicle.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.VSW.PeriodicFascicle";
