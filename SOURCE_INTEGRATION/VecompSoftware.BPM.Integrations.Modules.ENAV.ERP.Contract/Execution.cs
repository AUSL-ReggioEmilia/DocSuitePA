...
namespace VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ERP.Contract
{
    ...
    public class Execution : ModuleBase
    {
        ...
        protected override void Execute()
        {
            ...
            {
                _logger.WriteError(new LogMessage("***REMOVED***.ERP.Contract -> Critical Error"), ex, LogCategories);
                throw;
            }
        }
        ...
        protected override void OnStop()
        {
            CleanSubscriptions();
            _dbContext.Dispose();
            _logger.WriteInfo(new LogMessage("OnStop -> ***REMOVED***.ERP.Contract"), LogCategories);
        }
