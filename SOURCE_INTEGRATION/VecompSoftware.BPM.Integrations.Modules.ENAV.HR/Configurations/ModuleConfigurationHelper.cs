...
namespace VecompSoftware.BPM.Integrations.Modules.***REMOVED***.HR.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.***REMOVED***.HR";
