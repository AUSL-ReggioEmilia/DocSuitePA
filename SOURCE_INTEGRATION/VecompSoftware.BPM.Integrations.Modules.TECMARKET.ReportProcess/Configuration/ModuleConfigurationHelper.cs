...
namespace VecompSoftware.BPM.Integrations.Modules.TECMARKET.ReportProcess.Configuration
{
    public static class ModuleConfigurationHelper
    {
        ...
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.TECMARKET.ReportProcess";
