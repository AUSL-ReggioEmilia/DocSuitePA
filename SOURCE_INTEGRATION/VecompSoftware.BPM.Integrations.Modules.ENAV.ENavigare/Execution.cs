...
using VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ENavigare.Configurations;
using VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ENavigare.Data;
...
namespace VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ENavigare
{
    ...
    public class Execution : ModuleBase
    {
            ...
            : base(logger, ModuleConfigurationHelper.MODULE_NAME)
        {
            ...
            {
                _logger.WriteError(new LogMessage("***REMOVED***.ENavigare -> Critical error in costruction module"), ex, LogCategories);
                throw;
            }
        }
        #endregion
        ...
        protected override void Execute()
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.WriteError(new LogMessage("***REMOVED*** E_Navigare -> Critical Error"), ex, LogCategories);
                throw;
            }
        }
        ...
        protected override void OnStop()
        {
            CleanSubscriptions();
            _dbContext.Dispose();
            _logger.WriteInfo(new LogMessage("OnStop -> ***REMOVED***.ENavigare"), LogCategories);
        }
