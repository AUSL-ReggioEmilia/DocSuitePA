...
namespace VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ENavigare.Configurations
{
    public class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.***REMOVED***.ENavigare";
