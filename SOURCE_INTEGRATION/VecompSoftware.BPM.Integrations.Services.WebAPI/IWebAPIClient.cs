...
namespace VecompSoftware.BPM.Integrations.Services.WebAPI
{
    public interface IWebAPIClient
    {
        ...
        Task PushCorrelatedNotificationAsync(string message, string moduleName, Guid tenantId, string tenantName, Guid? correlationId, IIdentityContext identity, NotificationType notificationType);
        ...
        Task<AdvancedProtocol> GetAdvancedProtocolAsync(short year, int number);
        ...
        Task<ICollection<PECMail>> GetPECMailFromProtocol(short year, int number);
