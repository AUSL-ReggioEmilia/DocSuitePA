...
namespace VecompSoftware.BPM.Integrations.Modules.VSW.PayableInvoiceFileSystem.Configuration
{
    public class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.VSW.PayableInvoiceFileSystem";
