...
namespace VecompSoftware.BPM.Integrations.Modules.VSW.Management.Audit.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.VSW.Management.Audit";
