...
namespace VecompSoftware.BPM.Integrations.Modules.TECMARKET.Reporting.Configuration
{
    public static class ModuleConfigurationHelper
    {
        ...
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.TECMARKET.Reporting";
