...
using VecompSoftware.BPM.Integrations.Modules.AUSLRE.RequestOpinon.Models;

namespace VecompSoftware.BPM.Integrations.Modules.AUSLRE.RequestOpinon.Configuration
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.AUSLRE.RequestOpinion";
