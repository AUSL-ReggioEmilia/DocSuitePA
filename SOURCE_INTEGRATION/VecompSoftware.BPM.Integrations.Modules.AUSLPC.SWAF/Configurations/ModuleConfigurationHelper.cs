...
namespace VecompSoftware.BPM.Integrations.Modules.AUSLPC.SWAF.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.AUSLPC.SWAF";
