...
namespace VecompSoftware.BPM.Integrations.Modules.AUSLPC.COVID19.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.AUSLPC.COVID19";
