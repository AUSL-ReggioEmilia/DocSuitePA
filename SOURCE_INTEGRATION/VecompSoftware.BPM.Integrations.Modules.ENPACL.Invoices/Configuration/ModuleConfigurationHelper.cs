...
namespace VecompSoftware.BPM.Integrations.Modules.ENPACL.Invoices.Configuration
{
    public class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.ENPACL.Invoices";
