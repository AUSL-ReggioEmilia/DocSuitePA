...
namespace VecompSoftware.BPM.Integrations.Modules.AUSLRE.AVELCO.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.AUSLRE.AVELCO";
