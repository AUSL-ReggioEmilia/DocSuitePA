...
using VecompSoftware.BPM.Integrations.Modules.ENAV.IP4D.Configurations;
using VecompSoftware.BPM.Integrations.Modules.ENAV.IP4D.Models;
...
namespace VecompSoftware.BPM.Integrations.Modules.ENAV.IP4D
{
    ...
    public class Execution : ModuleBase
    {
            ...
            : base(logger, ModuleConfigurationHelper.MODULE_NAME)
        {
            ...
            {
                _logger.WriteError(new LogMessage("ENAV.IP4D -> Critical error in costruction module"), ex, LogCategories);
                throw;
            }
        }
        #endregion
        ...
        protected override void Execute()
        {
            ...
            {
                _logger.WriteError(new LogMessage("ENAV IP4D -> Critical Error"), ex, LogCategories);
                throw;
            }
        }
        ...
        {
            CleanSubscriptions();
            _logger.WriteInfo(new LogMessage("OnStop -> ENAV.IP4D"), LogCategories);
        }
