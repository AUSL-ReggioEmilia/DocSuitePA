...
namespace VecompSoftware.BPM.Integrations.Modules.ENAV.IP4D.Configurations
{
    public static class ModuleConfigurationHelper
    {
        #region [ Fields ]
        public const string MODULE_NAME = "VecompSoftware.BPM.Integrations.Modules.ENAV.IP4D";
