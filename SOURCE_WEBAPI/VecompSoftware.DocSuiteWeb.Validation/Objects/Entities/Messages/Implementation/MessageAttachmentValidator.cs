...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Messages
{
    ...
    {
        #region [ Constructor ]
        public MessageAttachmentValidator(ILogger logger, IMessageAttachmentValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
