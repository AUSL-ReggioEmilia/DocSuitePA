...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Messages
{
    ...
    {
        #region [ Constructor ]
        public MessageLogValidator(ILogger logger, IMessageLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
