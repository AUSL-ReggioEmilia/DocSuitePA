...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Messages
{
    ...
    {
        #region [ Constructor ]
        public MessageContactEmailValidator(ILogger logger, IMessageContactEmailValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
