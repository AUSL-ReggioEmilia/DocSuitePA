...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Messages
{
    ...
    {
        #region [ Constructor ]
        public MessageEmailValidator(ILogger logger, IMessageEmailValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
