...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Processes
{
    public class ProcessFascicleTemplateValidator : ObjectValidator<ProcessFascicleTemplate, ProcessFascicleTemplateValidator>, IProcessFascicleTemplateValidator
    {
        ...
        public ProcessFascicleTemplateValidator(ILogger logger, IValidatorMapper<ProcessFascicleTemplate, ProcessFascicleTemplateValidator> mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
