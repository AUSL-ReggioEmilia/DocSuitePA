...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Dossiers
{
    public class DossierValidator : ObjectValidator<Dossier, DossierValidator>, IDossierValidator
    {
        ...
        public DossierValidator(ILogger logger, IDossierValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
