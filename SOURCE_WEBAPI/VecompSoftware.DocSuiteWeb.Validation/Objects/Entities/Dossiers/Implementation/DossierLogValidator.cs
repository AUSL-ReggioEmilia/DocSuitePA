...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Dossiers
{
    public class DossierLogValidator : ObjectValidator<DossierLog, DossierLogValidator>, IDossierLogValidator
    {
        ...
        public DossierLogValidator(ILogger logger, IDossierLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
