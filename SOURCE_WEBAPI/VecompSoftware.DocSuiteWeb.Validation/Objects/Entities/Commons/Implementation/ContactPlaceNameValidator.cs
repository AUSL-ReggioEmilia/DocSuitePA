...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Commons
{
    ...
    {
        #region [ Constructor ]
        public ContactPlaceNameValidator(ILogger logger, IContactPlaceNameValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
