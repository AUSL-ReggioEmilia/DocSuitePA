...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Commons
{
    ...
    {
        #region [ Constructor ]
        public LocationValidator(ILogger logger, ILocationValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
