...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Commons
{
    ...
    {
        #region [ Constructor ]
        public RoleGroupValidator(ILogger logger, IRoleGroupValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
