...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Commons
{
    ...
    {
        #region [ Constructor ]
        public CategoryFascicleValidator(ILogger logger, ICategoryFascicleValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
