...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.PECMails
{
    ...
    {
        #region [ Constructor ]
        public PECMailLogValidator(ILogger logger, IPECMailLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
