...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Fascicles
{
    ...
    {
        #region [ Constructor ]
        public FascicleRoleValidator(ILogger logger, IFascicleRoleValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
