...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.UDS
{
    ...
    {
        #region [ Constructor ]
        public UDSSchemaRepositoryValidator(ILogger logger, IUDSSchemaRepositoryValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
