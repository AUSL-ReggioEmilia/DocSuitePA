...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.UDS
{
    ...
    {
        #region [ Constructor ]
        public UDSLogValidator(ILogger logger, IUDSLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
