...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.UDS
{
    public class UDSDocumentUnitValidator : ObjectValidator<UDSDocumentUnit, UDSDocumentUnitValidator>, IUDSDocumentUnitValidator
    {
        ...
        #region [ Constructor ]
        public UDSDocumentUnitValidator(ILogger logger, IUDSDocumentUnitValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity security, IDecryptedParameterEnvService parameterEnvSecurity)
