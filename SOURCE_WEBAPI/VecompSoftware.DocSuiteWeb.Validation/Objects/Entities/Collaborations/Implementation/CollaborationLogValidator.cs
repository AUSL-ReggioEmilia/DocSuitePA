...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Collaborations
{
    ...
    {
        #region [ Constructor ]
        public CollaborationLogValidator(ILogger logger, ICollaborationLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
