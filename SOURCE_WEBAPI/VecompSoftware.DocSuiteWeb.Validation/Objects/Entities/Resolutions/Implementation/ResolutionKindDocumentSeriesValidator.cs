...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Resolutions
{
    ...
    {
        #region [ Constructor ]
        public ResolutionKindDocumentSeriesValidator(ILogger logger, IResolutionKindDocumentSeriesValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
