...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Resolutions
{
    ...
    {
        #region [ Constructor ]
        public ResolutionContactValidator(ILogger logger, IResolutionContactValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
