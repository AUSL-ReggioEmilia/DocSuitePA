...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Workflows
{
    ...
    {
        #region [ Constructor ]
        public WorkflowAuthorizationValidator(ILogger logger, IWorkflowAuthorizationValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
