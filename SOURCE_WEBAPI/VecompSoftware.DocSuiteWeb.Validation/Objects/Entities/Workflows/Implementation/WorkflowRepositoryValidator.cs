...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Workflows
{
    ...
    {
        #region [ Constructor ]
        public WorkflowRepositoryValidator(ILogger logger, IWorkflowRepositoryValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
