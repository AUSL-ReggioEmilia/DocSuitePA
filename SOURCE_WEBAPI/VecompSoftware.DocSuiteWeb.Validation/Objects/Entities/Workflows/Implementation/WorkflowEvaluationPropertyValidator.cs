...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Workflows
{
    ...
    {
        #region [ Constructor ]
        public WorkflowEvaluationPropertyValidator(ILogger logger, IWorkflowEvaluationPropertyValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity)
