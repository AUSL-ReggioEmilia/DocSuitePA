...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.OCharts
{
    ...
    {
        #region [ Constructor ]
        public OChartItemContainerValidator(ILogger logger, IOChartItemContainerValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
