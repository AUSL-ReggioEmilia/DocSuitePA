...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.DocumentArchives
{
    ...
    {
        #region [ Constructor ]
        public DocumentSeriesItemRoleValidator(ILogger logger, IDocumentSeriesItemRoleValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
