...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.DocumentArchives
{
    ...
    {
        #region [ Constructor ]
        public DocumentSeriesItemLogValidator(ILogger logger, IDocumentSeriesItemLogValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity security, IDecryptedParameterEnvService parameterEnvSecurity)
