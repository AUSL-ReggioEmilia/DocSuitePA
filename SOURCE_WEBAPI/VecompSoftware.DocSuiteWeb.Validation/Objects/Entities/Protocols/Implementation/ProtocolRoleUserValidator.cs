...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Protocols
{
    ...
    {
        #region [ Constructor ]
        public ProtocolRoleUserValidator(ILogger logger, IProtocolRoleUserValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity, IDecryptedParameterEnvService parameterEnvSecurity)
