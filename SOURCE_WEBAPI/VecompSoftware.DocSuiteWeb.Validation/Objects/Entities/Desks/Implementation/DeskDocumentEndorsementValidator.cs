...
namespace VecompSoftware.DocSuiteWeb.Validation.Objects.Entities.Desks
{
    ...
    {
        #region [ Constructor ]
        public DeskDocumentEndorsementValidator(ILogger logger, IDeskDocumentEndorsementValidatorMapper mapper, IDataUnitOfWork unitOfWork, ISecurity currentSecurity)
