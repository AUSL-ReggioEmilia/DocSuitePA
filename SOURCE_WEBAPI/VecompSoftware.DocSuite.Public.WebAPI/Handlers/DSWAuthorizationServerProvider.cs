                ...
                if (_validAuthenticationList == null)
                {
                    lock (_lockObject)
                    {
                        if (_validAuthenticationList == null)
                        {
                            ...
                            {
                                { "ENAV.IP4D", new KeyValuePair<Guid, string>(enav_IP4D, VALUE_ExternalViewer_AuthenticationRule_OAuth2) },
                                { "ENAV.ERP_CONTRATTI", new KeyValuePair<Guid, string>(enav_ERPContract, VALUE_ExternalViewer_AuthenticationRule_Token) },
