...
namespace VecompSoftware.DocSuite.Public.WebAPI.Controllers.CustomModules
{
    ...
    public class AUSLRE_BandiDiGaraDocumentsController : ApiController
    {
        ...
        #region [ Constructor ]
        public AUSLRE_BandiDiGaraDocumentsController(IDataUnitOfWork unitOfWork, ILogger logger, IDocumentContext<ModelDocument.Document, ModelDocument.ArchiveDocument> documentService)
            : base()
        {
            ...
            return await CommonHelpers.ActionHelper.TryCatchWithLoggerGeneric(async () =>
             {
                 ...
                 bool result = _unitOfWork.Repository<UDSFieldList>().ExecuteModelScalarFunction<bool>(CommonDefinition.SQL_FX_Get_UDS_T_BandiDiGara_HasDocument,
