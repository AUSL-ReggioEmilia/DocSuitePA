...
{
    public class WorkflowPropertyMap : EntityTypeConfiguration<WorkflowProperty>
    {
        public WorkflowPropertyMap()
            : base()
        {
            // Table
            ToTable("WorkflowProperties");
            // Primary Key
            HasKey(t => t.UniqueId);
            ...
            Property(x => x.UniqueId)
                .HasColumnName("IdWorkflowProperty")
            ...
            HasOptional(t => t.WorkflowActivity)
                .WithMany(t => t.WorkflowProperties)
