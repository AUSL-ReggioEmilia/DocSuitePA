...
{
    // Note:
    // PosteOnLineRequestMap a discriminator towards LOLRequest and it also maps common properties
    // Properties mapped here are complementary to properties mapped in PosteOnLineRequestMap
    public class LOLRequestMap : EntityTypeConfiguration<LOLRequest>
    {
        public LOLRequestMap()
        {
