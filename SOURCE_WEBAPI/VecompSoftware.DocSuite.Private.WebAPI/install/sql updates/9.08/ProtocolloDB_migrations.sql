...
--#############################################################################
PRINT 'Versionamento database alla 9.08'
GO

EXEC dbo.VersioningDatabase N'9.08',N'PrivateWebAPI Version','PrivateWebAPI MigrationDate'
GO
...
--#############################################################################
PRINT N'Modifica SQL Function [dbo].[Fascicles_FX_AuthorizedFascicles] ADD PARAMETERS @IsManager AND @IsSecretary';
GO
...
--#############################################################################
PRINT N'Modifica SQL Function [dbo].[Fascicles_FX_CountAuthorizedFascicles] ADD PARAMETERS @IsManager AND @IsSecretary';
GO
...
PRINT N'Alter sql function [webapiprivate].[Role_FX_FindRoles] - Adding UniqueId parameter'
GO
...
(
    ...
    WHERE
        ...
        (@UniqueId IS NULL OR (@UniqueId IS NOT NULL AND R.UniqueId = @UniqueId)) AND 
