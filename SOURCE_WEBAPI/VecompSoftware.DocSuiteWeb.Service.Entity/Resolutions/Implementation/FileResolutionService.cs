...
{
    public class FileResolutionService : BaseService<FileResolution>, IFileResolutionService
    {
        #region [ Fields ]
        ...
        public FileResolutionService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
