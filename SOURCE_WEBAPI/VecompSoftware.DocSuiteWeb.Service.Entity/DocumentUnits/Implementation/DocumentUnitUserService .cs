...
{
    public class DocumentUnitUserService : BaseService<DocumentUnitUser>, IDocumentUnitUserService
    {
        #region [ Fields ]
        ...
        #region [ Constructor ]
        public DocumentUnitUserService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
