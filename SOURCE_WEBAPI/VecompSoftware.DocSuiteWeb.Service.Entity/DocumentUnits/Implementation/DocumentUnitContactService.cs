...
{
    public class DocumentUnitContactService : BaseService<DocumentUnitContact>, IDocumentUnitContactService
    {
        #region [ Fields ]
        ...
        #region [ Constructor ]
        public DocumentUnitContactService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
