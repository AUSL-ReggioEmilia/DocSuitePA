...
{
    public class ProtocolUserService : BaseService<ProtocolUser>, IProtocolUserService
    {
        #region [ Fields ]
        ...
        public ProtocolUserService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
