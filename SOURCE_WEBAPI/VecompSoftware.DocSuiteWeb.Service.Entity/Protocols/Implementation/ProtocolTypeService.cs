...
{
    public class ProtocolTypeService : BaseService<ProtocolType>, IProtocolTypeService
    {
        #region [ Fields ]
        ...
        public ProtocolTypeService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
