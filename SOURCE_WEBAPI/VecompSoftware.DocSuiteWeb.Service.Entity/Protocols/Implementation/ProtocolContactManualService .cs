...
{
    public class ProtocolContactManualService : BaseService<ProtocolContactManual>, IProtocolContactManualService
    {
        #region [ Fields ]
        ...
        public ProtocolContactManualService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
