...
{
    public class ProtocolRoleUserService : BaseService<ProtocolRoleUser>, IProtocolRoleUserService
    {
        #region [ Fields ]
        ...
        public ProtocolRoleUserService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
