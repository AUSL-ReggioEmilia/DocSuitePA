...
{
    public class ProtocolDocumentTypeService : BaseService<ProtocolDocumentType>, IProtocolDocumentTypeService
    {
        #region [ Fields ]
        ...
        public ProtocolDocumentTypeService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
