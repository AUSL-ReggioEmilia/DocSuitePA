...
{
    public class ProtocolLinkService : BaseService<ProtocolLink>, IProtocolLinkService
    {
        #region [ Fields ]
        ...
        public ProtocolLinkService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
