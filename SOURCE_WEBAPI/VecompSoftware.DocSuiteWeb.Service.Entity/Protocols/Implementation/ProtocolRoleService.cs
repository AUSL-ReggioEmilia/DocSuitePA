...
{
    public class ProtocolRoleService : BaseService<ProtocolRole>, IProtocolRoleService
    {
        #region [ Fields ]
        ...
        public ProtocolRoleService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
