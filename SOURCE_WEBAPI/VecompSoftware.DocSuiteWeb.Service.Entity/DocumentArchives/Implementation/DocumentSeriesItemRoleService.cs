...
{
    public class DocumentSeriesItemRoleService : BaseService<DocumentSeriesItemRole>, IDocumentSeriesItemRoleService
    {
        #region [ Fields ]
        ...
        #region [ Constructor ]
        public DocumentSeriesItemRoleService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
