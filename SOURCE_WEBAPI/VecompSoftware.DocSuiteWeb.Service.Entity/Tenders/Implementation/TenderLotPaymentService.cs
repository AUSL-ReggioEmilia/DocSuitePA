...
{
    public class TenderLotPaymentService : BaseService<TenderLotPayment>, ITenderLotPaymentService
    {
        #region [ Fields ]
        ...
        public TenderLotPaymentService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
