...
{
    public class TenderLotService : BaseService<TenderLot>, ITenderLotService
    {
        #region [ Fields ]
        ...
        public TenderLotService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
