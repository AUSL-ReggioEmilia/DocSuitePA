...
{
    public class CollaborationSignService : BaseService<CollaborationSign>, ICollaborationSignService
    {
        #region [ Fields ]
        ...
        public CollaborationSignService(IDataUnitOfWork unitOfWork, ILogger logger, IValidatorService validationService,
