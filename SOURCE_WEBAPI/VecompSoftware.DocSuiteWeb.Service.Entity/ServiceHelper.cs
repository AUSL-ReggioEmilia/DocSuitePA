    ...
    public static class ServiceHelper
    {
        ...
        public static async Task<T> TryCatchWithLogger<T>(Func<Task<T>> func, ILogger logger, IEnumerable<LogCategory> logCategories)
        {
            ...
            catch (AggregateException ae)
            {
                ...
                throw new DSWException(string.Concat("Service entity layer - AggregateException in invoke operation: ", string.Join(", ", ae.InnerExceptions.Select(f => f.Message))),
            ...
            catch (Exception ex)
            {
                ...
                throw new DSWException(string.Concat("Service entity layer - unexpected exception was thrown while invoking operation: ", ex.Message), ex, DSWExceptionCode.SS_Anomaly);
            }
        }
