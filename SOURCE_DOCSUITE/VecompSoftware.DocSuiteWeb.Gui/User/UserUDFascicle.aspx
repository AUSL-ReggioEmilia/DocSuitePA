<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserUDFascicle.aspx.vb" Inherits="VecompSoftware.DocSuiteWeb.Gui.UserUDFascicle" MasterPageFile="~/MasterPages/DocSuite2008.Master" %>
                ...
                <Columns>
                    ...
                    <telerik:CompositeLayoutColumn HtmlTag="Div" CssClass="form-control dsw-vertical-middle" Span="9">
                        <Content>
                            ...
                            <asp:CheckBox runat="server" ID="chkRedThreshold" Text="Includi oltre 60 giorni" Checked="false" />
                        </Content>
