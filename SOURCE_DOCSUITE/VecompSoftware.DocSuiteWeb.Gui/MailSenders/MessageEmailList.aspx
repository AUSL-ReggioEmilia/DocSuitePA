    ...
    <asp:Panel runat="server" DefaultButton="cmdRefreshgrid" ID="pnlFilters">
        <table class="datatable">
            ...
            <tr>
                ...
                <td>
                    <span class="miniLabel">Da</span>
                    <div style="display: inline-block;" runat="server" id="inputSender" visible="false">
                        <asp:TextBox runat="server" ID="txtSender" Width="250px" Enabled="False" />
                    </div>
                    <div style="display: inline-block;" runat="server" id="dropdownSender" visible="false">
                        <telerik:RadComboBox runat="server" ID="ddlSender" AutoPostBack="true" Width="250px" AllowCustomText="true">
                        </telerik:RadComboBox>
                    </div>
            ...
            <tr>
                <td class="label"></td>
                <td>
                    <telerik:RadLabel runat="server" ID="errorDDLSender" Text="L'email non esiste" Visible="false" Style="color: red; margin-left: 1em;"></telerik:RadLabel>
                </td>
            </tr>
        </table>
