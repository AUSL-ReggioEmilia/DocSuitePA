<%@ Page AutoEventWireup="false" CodeBehind="ResolutionViewer.aspx.vb" Inherits="VecompSoftware.DocSuiteWeb.Gui.Viewers.ResolutionViewer" Language="vb" MasterPageFile="~/MasterPages/DocSuite2008.Master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphFooter">
        <asp:Button ID="btnSend"  OnClientClick="ShowLoadingPanel();" runat="server" Width="120px" Text="Invia Mail" PostBackUrl="~/MailSenders/ResolutionMailSender.aspx"/>
</asp:Content>