...
<asp:Content ID="ContentHeader" runat="server" ContentPlaceHolderID="cphHeader">
    <telerik:RadScriptBlock runat="server" ID="RadScriptBlock1" EnableViewState="false">
        <script type="text/javascript">
            ...
            function CloseSmartContact(sender, args) {
                if (args.get_argument() != null) {
                    UpdateContacts(JSON.parse(args.get_argument().contact).Id);
                }
            }
            ...
            function OpenSmartContactWindow(url) {
                return OpenWindow(url, 'windowSmartContact', WIDTH_EDIT_WINDOW, HEIGHT_PRINT_WINDOW);
            }
            ...
            function <%= Me.ID %>_UpdateSmart(contactType, contact) {
                UpdateContacts(JSON.parse(contact).Id);
            }
    ...
    <telerik:RadWindowManager EnableViewState="False" ID="RadWindowManagerContactLists" runat="server">
        <Windows>
            ...
            <telerik:RadWindow ID="windowSmartContact" Modal="true" runat="server" ShowContentDuringLoad="false" OnClientClose="CloseSmartContact" Title="Contatti - Aggiungi" VisibleStatusbar="false" />
                            ...
                            <telerik:RadPanelItem Id="pnlContacts" runat="server" Expanded="true">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel runat="server" ID="Panel1">
                                        <telerik:RadButton ID="btnAddContact" runat="server" Text="Aggiungi" />
