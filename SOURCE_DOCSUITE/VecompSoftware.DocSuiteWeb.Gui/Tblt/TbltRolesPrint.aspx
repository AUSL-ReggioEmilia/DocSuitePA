<%@ Page Language="vb" AutoEventWireup="false" Inherits="VecompSoftware.DocSuiteWeb.Gui.PrintRoles" Codebehind="TbltRolesPrint.aspx.vb" MasterPageFile="~/MasterPages/DocSuite2008.Master" Title="Selezione Settore per Stampa"%>
    ...
    <table style="height: 100%; width: 100%;">
        ...
        <tr>
            <td style="vertical-align: top; width: 50%;">
                <telerik:RadTreeView ID="RadTreeRole" runat="server" CheckBoxes="true">
                    <Nodes>
                        <telerik:RadTreeNode Checkable="false" Expanded="true" runat="server" Text="Settore" />
                    </Nodes>
                </telerik:RadTreeView>
            </td>
