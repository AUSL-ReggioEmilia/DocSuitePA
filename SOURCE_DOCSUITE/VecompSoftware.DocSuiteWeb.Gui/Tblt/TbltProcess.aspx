<%@ Page Language="vb" Title="Raccolta dei procedimenti" AutoEventWireup="false" CodeBehind="TbltProcess.aspx.vb" Inherits="VecompSoftware.DocSuiteWeb.Gui.TbltProcess" EnableViewState="True" MasterPageFile="~/MasterPages/DocSuite2008.Master" %>
        ...
        <script type="text/javascript">
            ...
            require(["Tblt/TbltProcess"], function (TbltProcess) {
                $(function () {
                    ...
                    tbltProcess.rcbFascicleTypeId = "<%= rcbFascicleType.ClientID %>";
            ...
            <div id="insertProcess">
                <asp:Panel ID="pnlAggiungi" runat="server">
                    <table class="dataform">
                        ...
                        <tr>
                            <td class="label">Tipo di fascicolo:</td>
                            <td>
                    ...
                    <usc:uscRoleRest runat="server" ID="uscProcessRoleRest" ReadOnlyMode="false" MultipleRoles="true"
                        Required="true" RequiredMessage="Campo settore obligatorio" Collapsable="true" Caption="Settori autorizzati" />
                </asp:Panel>
            </div>
        ...
        <telerik:RadPane runat="server" Width="100%" Height="100%" Scrolling="None" ID="Pane1">
            <telerik:RadToolBar AutoPostBack="False" ID="filterToolbar" RenderMode="Lightweight" EnableRoundedCorners="False" EnableShadows="False" runat="server" Width="100%">
                <Items>
                    ...
                    <telerik:RadToolBarButton Value="statusInput" PostBack="false">
                        <ItemTemplate>
                            <telerik:RadComboBox ID="rcbProcessStatus" runat="server" AutoPostBack="False" Width="100px"></telerik:RadComboBox>
                        </ItemTemplate>
                    </telerik:RadToolBarButton>
                    <telerik:RadToolBarButton IsSeparator="true" />
            ...
            <telerik:RadToolBar AutoPostBack="false" EnableRoundedCorners="False" EnableShadows="False" ID="FolderToolBar" runat="server" Width="100%" RenderMode="Lightweight">
                <Items>
                    <telerik:RadToolBarButton ToolTip="Aggiungi" CheckOnClick="false" Checked="false" Value="create" ImageUrl="~/App_Themes/DocSuite2008/imgset16/Add_Folder.png" />
                    <telerik:RadToolBarButton ToolTip="Modifica" CheckOnClick="false" Checked="false" Value="modify" ImageUrl="~/App_Themes/DocSuite2008/imgset16/modify_folder.png" />
                    <telerik:RadToolBarButton ToolTip="Elimina" CheckOnClick="false" Checked="false" Value="delete" ImageUrl="~/App_Themes/DocSuite2008/imgset16/DeleteFolder.png" />
                    <telerik:RadToolBarButton ToolTip="Aggiungi modello di fascicolo di processo" CheckOnClick="false" Checked="false" Value="createProcessFascicleTemplate" ImageUrl="~/App_Themes/DocSuite2008/imgset16/folder_add.png" />
                </Items>
            </telerik:RadToolBar>
            <telerik:RadTreeView ID="rtvProcesses" LoadingStatusPosition="BeforeNodeText" PersistLoadOnDemandNodes="false" runat="server" Style="margin-top: 10px;" Width="100%">
                <Nodes>
                    <telerik:RadTreeNode Expanded="true" NodeType="Root" runat="server" Selected="true" Text="Procedimenti" Value="" />
                </Nodes>
            </telerik:RadTreeView>
        </telerik:RadPane>
