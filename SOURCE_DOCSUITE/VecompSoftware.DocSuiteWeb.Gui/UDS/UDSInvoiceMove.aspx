    ...
    <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
            ...
            function onDoneSignalRConnectionCallback() {
                ...
                var workflowName = "Fatturazione elettronica - Sposta fattura";
                var evt = {
                ...
                workflowStartModel.Arguments["_dsw_p_ActivityName"] = { "PropertyType": 8, "Name": "_dsw_p_ActivityName", "ValueString": "Sposta fattura" };
