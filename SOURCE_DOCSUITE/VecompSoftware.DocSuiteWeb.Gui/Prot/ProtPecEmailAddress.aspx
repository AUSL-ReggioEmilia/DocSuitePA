<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProtPecEmailAddress.aspx.vb" Inherits="VecompSoftware.DocSuiteWeb.Gui.ProtPecEmailAddress"
    MasterPageFile="~/MasterPages/DocSuite2008.Master" Title="Protocollo - Inserimento indirizzo E-Mail" %>
    ...
    <table height="100%" width="100%">
        ...
        <tr>
            <td class="content-wrapper">
                <div class="content">
                    <asp:DataList ID="dlstAddresses" runat="server" DataKeyField="Id" Width="100%">
                        <ItemTemplate>
                            <asp:Panel ID="pnlAggiungi" runat="server">
                                <table id="Table1" class="dataform">
                                    <tr>
                                        <td class="label" width="40%">
                                            <b>Casella PEC di "<%# Eval("Name") %>":</b>
                                        </td>
                                        <td width="60%" colspan="2">
                                            <asp:TextBox ID="txtCertifiedMail" runat="server" Width="250px" MaxLength="100"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>    
