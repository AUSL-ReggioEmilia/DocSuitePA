<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/DocSuite2008.Master" CodeBehind="PosteWebCostiAccount.aspx.vb" Inherits="VecompSoftware.DocSuiteWeb.Gui.Prot.PosteWeb.CostiAccount" %>
    ...
    <asp:Panel ID="pnlDgPoste" runat="server" Visible="True" Width="100%">
        <telerik:RadGrid AutoGenerateColumns="False" ShowGroupPanel="True" GroupingEnabled="True" GridLines="Vertical" ID="dgPosteRequestContact" runat="server" >
            ...
            <MasterTableView AllowNaturalSort="true" AllowSorting="true" ShowGroupFooter="true">
                ...
                <Columns>
                    <telerik:GridBoundColumn Groupable="true" DataField="Account" HeaderText="Account" SortExpression="Account" UniqueName="Account" />
