define(["require", "exports", "App/Helpers/EnumHelper"], function (require, exports, EnumHelper) {
    var PECMailViewModelMapper = /** @class */ (function () {
        function PECMailViewModelMapper() {
            this._enumHelper = new EnumHelper();
        }
        PECMailViewModelMapper.prototype.Map = function (source) {
            var toMap = {};
            if (!source) {
                return null;
            }
        ...
        return PECMailViewModelMapper;
    }());
    return PECMailViewModelMapper;
});
//# sourceMappingURL=PECMailViewModelMapper.js.map