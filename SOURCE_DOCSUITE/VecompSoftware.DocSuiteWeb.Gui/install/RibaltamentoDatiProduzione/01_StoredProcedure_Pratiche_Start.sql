...
-- Description:	Ribaltamento dati da Produzione per Validazione - Pratiche - Start
-- =============================================
CREATE PROCEDURE GenerateValidationData_Start
	...
	@ValidationDomainName varchar(MAX) = 'LABENAV',
...
BEGIN
	...
	-- PRINT 'Inizio transazione Pratiche - Parte Condivisa'
	...
	IF (@@ROWCOUNT = 0 )
	BEGIN
		INSERT INTO [Location]([idLocation],[Name],[DocumentServer],[DocmBiblosDSDB],[ProtBiblosDSDB],[ReslBiblosDSDB])
		VALUES (@DefaultLocationId,@DefaultLocationNameDocm,@DefaultLocationDocumentServer,@DefaultLocationDocmBiblosDSDB,@DefaultLocationProtBiblosDSDB,@DefaultLocationReslBiblosDSDB)
	END
	SET NOCOUNT OFF;
	...
	-- Aggiornamento Location di Pratiche
	-- PRINT 'Aggiornamento Location di Pratiche'
	UPDATE [Document] SET [Location] = @DefaultLocationId where [Location] is not null
	...
	VALUES (1,@AdminGroupName,1,'Admin',NULL,NULL,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Admin')
