...
Infatti riguarda la creazione di un nuovo LogType per l'invio a settori in ProtocolLog per ENAV che si attiva con il parametro IsLogSendToRolesEnable.
...
Per ENAV e tutti i clienti che avevano il parametro 'MailCategorySelection' attivo, va attivato il nuovo parametro 'MailRecipientsSelectionEnabled'.
