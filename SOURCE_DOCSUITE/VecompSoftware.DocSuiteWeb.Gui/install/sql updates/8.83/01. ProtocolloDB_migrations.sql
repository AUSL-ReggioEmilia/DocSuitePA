...
EXEC dbo.VersioningDatabase N'8.83',N'DSW Version','MigrationDate'
GO
...
GO
--#############################################################################
PRINT N'ALTER [dbo].[TaskHeader] ADD COLUMN [SendingProcessStatus]';
GO

ALTER TABLE [dbo].[TaskHeader] ADD [SendingProcessStatus] SMALLINT NULL;
GO

UPDATE [dbo].[TaskHeader] SET [SendingProcessStatus] = CASE [Status]
													   WHEN 0 THEN 1
													   ELSE 4
													   END
GO

ALTER TABLE [dbo].[TaskHeader] ALTER COLUMN [SendingProcessStatus] SMALLINT NOT NULL;
GO

ALTER TABLE [dbo].[TaskHeader] ADD CONSTRAINT DF_Taskheader_SendingProcessStatus DEFAULT 1 FOR [SendingProcessStatus]
GO
...
--#############################################################################
PRINT N'ALTER [dbo].[TaskHeader] ADD COLUMN [SendedStatus]';
GO

ALTER TABLE [dbo].[TaskHeader] ADD [SendedStatus] SMALLINT NULL;
GO
