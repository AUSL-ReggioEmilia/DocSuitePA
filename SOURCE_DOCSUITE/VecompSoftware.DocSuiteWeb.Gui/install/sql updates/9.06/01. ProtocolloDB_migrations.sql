...
EXEC dbo.VersioningDatabase N'9.06',N'DSW Version','MigrationDate'
GO
  ...
  <xs:complexType name="Document">
    <xs:complexContent>
      <xs:extension base="DynamicBaseType">
        ...
        <xs:attribute name="CopyUDS" type="xs:boolean" use="required" />
...
GO
--#############################################################################
PRINT N'ALTER TABLE [dbo].[PECMailBox] DROP DEFAULT CONSTRAINT OF [HumanEnabled]'
GO
...
SET @table_name = 'PECMailBox'
SET @schema_name = 'dbo'
SET @col_name = 'HumanEnabled'
...
PRINT N'EXECUTING COMMAND ' + @Command
EXECUTE (@Command)
GO
...
--#############################################################################
PRINT N'ALTER TABLE [dbo].[PECMailBox] DROP COLUMN [HumanEnabled]'
GO

ALTER TABLE [dbo].[PECMailBox] DROP COLUMN [HumanEnabled]
GO
...
--#############################################################################
PRINT N'ALTER TABLE [dbo].[PECMailBox] ADD COLUMN [LoginError]'
GO

ALTER TABLE [dbo].[PECMailBox] ADD [LoginError] bit null
GO

UPDATE [dbo].[PECMailBox] SET [LoginError] = 0
GO

ALTER TABLE [dbo].[PECMailBox] ALTER COLUMN [LoginError] bit not null
GO

ALTER TABLE [dbo].[PECMailBox] ADD CONSTRAINT DF_PECMailBox_LoginError DEFAULT 0 FOR [LoginError]
GO
...
--#############################################################################
PRINT N'ALTER TABLE [dbo].[Fascicles] ADD COLUMN [CustomActions]'
GO

ALTER TABLE [dbo].[Fascicles] ADD [CustomActions] nvarchar(max) null
GO
...
--#############################################################################
PRINT N'ALTER TABLE [dbo].[CategoryFascicles] ADD COLUMN [CustomActions]'
GO

ALTER TABLE [dbo].[CategoryFascicles] ADD [CustomActions] nvarchar(max) null
GO
