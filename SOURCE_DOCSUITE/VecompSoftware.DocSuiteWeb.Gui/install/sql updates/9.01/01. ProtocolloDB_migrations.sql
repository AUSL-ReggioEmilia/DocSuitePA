...
EXEC dbo.VersioningDatabase N'9.01',N'DSW Version','MigrationDate'
GO
...
GO
--#############################################################################
PRINT 'Drop constraint DF_Processes_FascicleType from table [dbo].[Processes]'
GO
...
GO
--#############################################################################
PRINT 'Drop column FascicleType from table [dbo].[Processes]'
GO

ALTER TABLE [dbo].[Processes] DROP COLUMN FascicleType
GO
