...
Per ***REMOVED***: NON LANCIARE ProtocolloDB_bonifica, ma lanciare i due script contenuti nella cartella ***REMOVED*** in questo ordine:
						01_***REMOVED***_ProtocolloDB_bonifica_NULL {DA NON DA LANCIARE IN PRODUZIONE}
						02_***REMOVED***_ProtocolloDB_bonifica_UPDATE {DA NON DA LANCIARE IN PRODUZIONE}
						03_***REMOVED***_ProtocolloDB_bonifica_NOTNULL {UNICO SCRIPT DA LANCIARE IN PRODUZIONE}
