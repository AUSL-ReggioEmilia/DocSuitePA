...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolContact]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolContact]';
GO
...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolRole]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolRole]';
GO
...
GO
--#############################################################################
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolParer]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolParer]';
GO
...
GO
--#############################################################################
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolContactManual]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolContactManual]';
GO
...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolLog]';
GO
...
PRINT 'Modifica colonna [UniqueIdProtocol] nella tabella [ProtocolLog]';
GO
...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolRoleUser]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolRoleUser]';
GO
...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolMessage]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocol], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolMessage]';
GO
...
PRINT 'Modifica colonna [UniqueId] nella tabella [ProtocolLinks]';
GO
...
PRINT 'Modifica colonne [UniqueIdProtocolParent], [UniqueIdProtocolSon], [RegistrationDate], [RegistrationUser], [LastChangedDate], [LastChangedUser] nella tabella [ProtocolLinks]';
GO
