...
Esempio: 
	 Indicare per la singola tipologia di catena il nome dalla label richiesta dal cliente (es. configurazione per ENAV)  
	   {
        "MainChain": "Procedure",
...
Per il solo cliente ENAV nel modulo VecompSoftware.DocSuite.BPM.Integrations.Modules.ENAV.ENavigare del servizio Workflow Integrations
