...
PRINT 'Versionamento database alla 8.60'
GO

EXEC dbo.VersioningDatabase N'8.60'
GO
...
PRINT 'Eliminazione colonna ConservationYear nella tabella Category'
GO

ALTER TABLE [dbo].[Category] DROP COLUMN [ConservationYear]
GO
...
PRINT 'Eliminazione colonna [IdDocumentSeriesItem] nella tabella [FascicleDocumentSeriesItems]'
GO

ALTER TABLE [dbo].[FascicleDocumentSeriesItems] DROP COLUMN [IdDocumentSeriesItem]
GO
...
PRINT 'Aggiungo la colonna [NoteType] nella tabella [ProtocolRole]';
GO

ALTER TABLE [dbo].[ProtocolRole] ADD  [NoteType] [smallint] NULL
GO

UPDATE [dbo].[ProtocolRole] SET [NoteType]= 0 WHERE [NoteType] is NULL
GO
...
PRINT 'Aggiungo la colonna [NoteType] nella tabella [ProtocolRejectedRoles]';
GO

ALTER TABLE [dbo].[ProtocolRejectedRoles] ADD  [NoteType] [smallint] NULL
GO

UPDATE [dbo].[ProtocolRejectedRoles] SET [NoteType] = 0 WHERE [NoteType] is NULL
GO
...
PRINT N'Modifico la Function [dbo].[FascicleDocumentUnits]';
GO
...
PRINT N'Modifico la Function [dbo].[FascicleGenericDocumentUnits]';
GO

ALTER FUNCTION [dbo].[FascicleGenericDocumentUnits]
(
    @FascicleId uniqueidentifier,
...
PRINT 'Aggiungo la colonna [DefaultAdaptiveSearchControls] nella tabella [UserLog]';
GO

ALTER TABLE [dbo].[UserLog] ADD [DefaultAdaptiveSearchControls] [nvarchar](MAX) NULL
GO
...
PRINT 'Aggiungo la colonna [AdaptiveSearchStatistics] nella tabella [UserLog]';
GO

ALTER TABLE [dbo].[UserLog] ADD [AdaptiveSearchStatistics] [nvarchar](MAX) NULL
GO
...
PRINT 'Aggiungo la colonna [AdaptiveSearchEvaluated] nella tabella [UserLog]';
GO

ALTER TABLE [dbo].[UserLog] ADD [AdaptiveSearchEvaluated] [nvarchar](MAX) NULL
GO
