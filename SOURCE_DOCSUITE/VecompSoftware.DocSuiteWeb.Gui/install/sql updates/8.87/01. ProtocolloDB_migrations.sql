...
EXEC dbo.VersioningDatabase N'8.87',N'DSW Version','MigrationDate'
GO
...
--#############################################################################
PRINT N'ALTER TABLE [dbo].[Processes] ALTER COLUMN [FascicleType] smallint NOT NULL'
GO
ALTER TABLE [dbo].[Processes] DROP CONSTRAINT [DF_Processes_FascicleType]
GO
ALTER TABLE [dbo].[Processes] ALTER COLUMN [FascicleType] smallint NOT NULL
GO
ALTER TABLE [dbo].[Processes] ADD  CONSTRAINT [DF_Processes_FascicleType]  DEFAULT ((1)) FOR [FascicleType]
GO
...
--#############################################################################
PRINT N'Aggiungere la colonna ProcessType nella tabella Processes'
GO
ALTER TABLE [dbo].[Processes] ADD [ProcessType] [smallint] NOT NULL
GO
ALTER TABLE [dbo].[Processes] ADD CONSTRAINT [DF_Processes_ProcessType] DEFAULT ((0)) FOR [ProcessType]
GO
