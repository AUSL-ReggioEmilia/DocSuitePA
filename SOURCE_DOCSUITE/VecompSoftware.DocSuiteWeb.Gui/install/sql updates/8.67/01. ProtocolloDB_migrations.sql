...
PRINT N'ALTER TABLE  [uds].[UDSRepositories] ';
GO

ALTER TABLE [uds].[UDSRepositories]  ALTER COLUMN [IdContainer] [smallint] NULL
GO
...
--#############################################################################
PRINT 'Modificata colonna ChainType in DossierDocuments';
GO

ALTER TABLE [dbo].[DossierDocuments] ALTER COLUMN [ChainType] INTEGER
GO
...
--#############################################################################
PRINT 'Modificata colonna ChainType in FascicleDocuments';
GO

ALTER TABLE [dbo].[FascicleDocuments] ALTER COLUMN [ChainType] INTEGER
GO
...
--#############################################################################
PRINT 'Modificata colonna ChainType in TemplateCollaborationDocumentRepositories';
GO

ALTER TABLE [dbo].[TemplateCollaborationDocumentRepositories] ALTER COLUMN [ChainType] INTEGER
GO
...
--#############################################################################
PRINT 'Modificata colonna ChainType in DocumentUnitChains';
GO

ALTER TABLE [cqrs].[DocumentUnitChains] ALTER COLUMN [ChainType] INTEGER
GO
...
--#############################################################################
PRINT N'Aggiunta colonna DematerialisationChainId in Protocol';
GO

ALTER TABLE [dbo].[Protocol] ADD [DematerialisationChainId] UNIQUEIDENTIFIER NULL
GO
...
--#############################################################################
PRINT N'Aggiunta colonna DematerialisationChainId in DocumentSeriesItem';
GO

ALTER TABLE [dbo].[DocumentSeriesItem] ADD [DematerialisationChainId] UNIQUEIDENTIFIER NULL
GO
