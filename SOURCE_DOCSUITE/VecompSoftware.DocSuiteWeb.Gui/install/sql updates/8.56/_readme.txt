...
ATTENZIONE: una volta terminata la versione 8.56, gli script di Protocollo e Pratiche (sia DSW sia WebAPI) vanno aggiunti agli script 
			ProtocolloDB_before_migrations.sql e PraticheDB_before_migrations.sql presenti nella cartella ENAV.

#SDC
#################################################################

E' stato introdotto un nuovo parametro "WorkflowManagerEnabled" per ENAV, il quale se abilitato:
