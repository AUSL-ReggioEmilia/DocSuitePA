...
GO
--#############################################################################
PRINT 'ALTER TABLE [dbo].[TenantAOO] ADD [TenantTypology]'
GO

ALTER TABLE [dbo].[TenantAOO] ADD [TenantTypology] smallint NOT NULL DEFAULT (0)
GO
...
--#############################################################################
PRINT 'ALTER TABLE [dbo].[Tenants] ADD [TenantTypology]'
GO

ALTER TABLE [dbo].[Tenants] ADD [TenantTypology] smallint NOT NULL DEFAULT (0)
GO
...
--#############################################################################
PRINT 'ALTER TABLE [dbo].[MessageAttachment] DROP COLUMN [Server]'
GO
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE [dbo].[MessageAttachment] DROP COLUMN [Server]
  END
GO
