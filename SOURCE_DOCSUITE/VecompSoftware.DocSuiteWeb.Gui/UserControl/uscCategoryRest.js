...
define(["require", "exports", "../App/Services/Commons/CategoryService", "../App/Helpers/ServiceConfigurationHelper", "../App/Models/Commons/CategoryModel"], function (require, exports, CategoryService, ServiceConfigurationHelper, CategoryModel) {
    var uscCategoryRest = /** @class */ (function () {
            ...
            */
            ...
            this.windowSelCategory_onClose = function (sender, args) {
                ...
                if (category) {
                    ...
                    _this.createNode(category).
                        done(function (node) {
                        node.get_attributes().setAttribute("IsSelected", true);
                        _this._treeCategory.commitChanges();
                        _this.addToSelectedSource(category);
                        $("#" + _this.pnlMainContentId).triggerHandler(uscCategoryRest.ADDED_EVENT, category.IdCategory);
        ...
        Object.defineProperty(uscCategoryRest.prototype, "toolbarActions", {
            get: function () {
                var _this = this;
                var items = [
        ...
        */
        ...
        uscCategoryRest.prototype.addDefaultNode = function (categoryModel) {
            this._treeCategory.get_nodes().clear();
            var currentNode = new Telerik.Web.UI.RadTreeNode();
