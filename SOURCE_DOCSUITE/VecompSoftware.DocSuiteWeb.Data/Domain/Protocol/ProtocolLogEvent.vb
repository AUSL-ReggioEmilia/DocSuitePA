...
Public Enum ProtocolLogEvent
    ...
    PZ
    ''' <summary>Accettazione/Rifiuto autorizzazione</summary>
    ...
    PS
    ''' <summary>Visualizzazione Sommario - Prima visualizzazione Protocollo</summary>
    ''' <remarks>Work around bug righe duplicate</remarks>
    <Description("P - Visualizzazione Sommario")>
    P1
    ''' <summary>Visualizzazione Documento</summary>
    <Description("P - Visualizzazione Documento")>
    PD
    ''' <summary>Elenco Documenti</summary>
    <Description("P - Elenco Documenti")>
    PE
    ''' <summary>Interoperabilità</summary>
    <Description("P - Interoperabilità")>
    PT
    ''' <summary>Invio Protocollo verso terzi</summary>
    <Description("P - Invio Protocollo verso terzi")>
    PO
    ''' <summary> Rigetto di protocollo </summary>
    <Description("P - Rigetto di protocollo")>
    PR
    ''' <summary>Errore</summary>
    <Description("Errore")>
    PX
    ''' <summary>Rispondi da PEC</summary>
    <Description("Rispondi da PEC")>
    PP
    ''' <summary>Correzione</summary>
    <Description("P - Correzione")>
    PC
    ''' <summary>Protocollo collegato ad atto</summary>
    <Description("P - Protocollo collegato ad atto")>
    PL
    ''' <summary>Protocollo in evidenza</summary>
