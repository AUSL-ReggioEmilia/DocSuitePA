...
namespace VecompSoftware.ServiceBus.Module.Workflow.Listener.SecurePaper
{
    ...
    public class Listener : ListenerMessageBase<ICommandSecurePaperRequest>, IListenerMessageGeneric<ICommandSecurePaperRequest>
    {
        public Listener(MessageReceiver receiver, ILogger logger, IWebAPIClient webApiClient, BiblosDS.BiblosClient biblosClient, StampaConforme.StampaConformeClient stampaConformeClient)
            : base(receiver, logger, new Execution(logger, webApiClient, biblosClient, stampaConformeClient), "CommandSecurePaperRequest")
        {
