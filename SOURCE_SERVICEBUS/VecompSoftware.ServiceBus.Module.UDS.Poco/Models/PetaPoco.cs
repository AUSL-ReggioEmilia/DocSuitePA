...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        {
            return Insert("dbo", tableName, primaryKeyName, true, poco);
        }
        ...
        public object Insert(string dbSchema, string tableName, string primaryKeyName, bool autoIncrement, object poco)
        {
            try
            {
                OpenSharedConnection();
                try
                {
                    using (IDbCommand cmd = CreateCommand(_sharedConnection, ""))
                    {
                        ...
                        cmd.CommandText = string.Format("SET LANGUAGE Italian; INSERT INTO {0}.{1} ({2}){3} VALUES ({4})",
                                dbSchema,
        ...
        {
            return Update("dbo", tableName, primaryKeyName, poco, primaryKeyValue, null);
        }
        ...
        public int Update(string dbSchema, string tableName, string primaryKeyName, object poco, object primaryKeyValue, IEnumerable<string> columns)
        {
            try
            {
                OpenSharedConnection();
                try
                {
                    using (IDbCommand cmd = CreateCommand(_sharedConnection, ""))
                    {
                        ...
                        cmd.CommandText = string.Format("SET LANGUAGE Italian; UPDATE {0}.{1} SET {2} WHERE {3} = {4}{5}",
                            dbSchema, _dbType.EscapeTableName(tableName), sb.ToString(), _dbType.EscapeSqlIdentifier(primaryKeyName), _paramPrefix, index++);
        ...
        /// <param name="columns">The column names of the columns to be updated, or null for all</param>
        /// <returns>The number of affected rows</returns>
        public int Update(string dbSchema, string tableName, string primaryKeyName, object poco, IEnumerable<string> columns)
        {
            return Update(dbSchema, tableName, primaryKeyName, poco, null, columns);
        }
        ...
        public void Save(string tableName, string primaryKeyName, object poco)
        {
            ...
            {
                Insert("dbo", tableName, primaryKeyName, true, poco);
            }
            else
            {
