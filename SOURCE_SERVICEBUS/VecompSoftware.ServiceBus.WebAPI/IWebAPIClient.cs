...
namespace VecompSoftware.ServiceBus.WebAPI
{
    public interface IWebAPIClient
    {
        ...
        Task<Fascicle> GetFascicleByIdAsync(Guid uniqueId);
        ...
        Task<TFascicolable> PutFascicolableEntityAsync<TFascicolable, TEntity>(TFascicolable fascicolableEntity)
            where TFascicolable : DSWBaseEntity, IDSWEntityFascicolable<TEntity>
            where TEntity : DSWBaseEntity;
        Task<WorkflowResult> PushWorkflowNotifyAsync(WorkflowNotify entity);
        ...
        Task<WorkflowProperty> GetWorkflowActivityProperty(Guid idWorkflowActivity, string propertyName);
        Task<FascicleFolder> GetFascicleFolderAsync(Guid uniqueId);
        Task<FascicleDocument> GetFascicleDocumentByFolderAsync(Guid fascicleFolderId);
        ...
        Task<short?> GetParameterMessageLocation();
        Task<int?> GetParameterCollaborationLocation();
        Task<short?> GetParameterFascicleMiscellaneaLocation();
        Task<Dossier> GetDossierByIdAsync(Guid uniqueId, string optionalFilter = null);
        Task<DossierFolder> GetDossierFolderParentAsync(Guid idDossierFolder);
        Task<DossierFolder> GetDossierFolderAsync(Guid idDossierFolder);
    }
}