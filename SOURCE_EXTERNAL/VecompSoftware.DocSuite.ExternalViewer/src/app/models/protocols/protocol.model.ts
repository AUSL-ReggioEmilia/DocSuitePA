...
import { ProtocolUserModel } from './protocol-user.model';


export class ProtocolModel implements DocumentUnitModel, BaseModel, IdentifierModel, BaseServiceModel {
    constructor() {
        this.serviceModelName = "ProtocolModel";
    }
